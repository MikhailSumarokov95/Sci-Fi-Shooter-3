...
namespace InfimaGames.LowPolyShooterPack.Interface
{
    ...
    public class CanvasAlpha : Element
    {
        ...
        protected override void Tick()
        {
            ...
            //Update Alpha.
            canvasGroup.alpha = Mathf.Lerp(canvasGroup.alpha, StateGameManager.StateGame == StateGameManager.State.Game ? 1.0f : cursorUnlockedAlpha, Time.deltaTime * interpolationSpeed);
        }
